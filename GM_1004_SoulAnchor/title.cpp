...
{
	//îwåi
	AddGameObject<Sprite2D>(UI)->Init(0.0f, 0.0f, SCREEN_WIDTH, SCREEN_HEIGHT, "asset\\texture\\TitleScene\\title_background.jpg");
	...
	AddGameObject<Sprite2D>(UI)->Init(900, 600, 300, 100, "asset\\texture\\TitleScene\\UI\\UI_start.png");
